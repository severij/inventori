...
import type { AppSettings, Theme, Language, Currency, DateFormat, ItemCountMethod, ValueCalculation, ImageMaxSize, ImageQuality } from '../types/settings';
...
function loadSettings(): AppSettings {
  try {
    return {
      ...
      imageMaxSize: (parseInt(localStorage.getItem(SETTINGS_KEYS.IMAGE_MAX_SIZE) || '') as ImageMaxSize) || DEFAULT_SETTINGS.imageMaxSize,
      imageQuality: (parseInt(localStorage.getItem(SETTINGS_KEYS.IMAGE_QUALITY) || '') as ImageQuality) || DEFAULT_SETTINGS.imageQuality,
    };
  } catch {
...
function saveSettings(settings: AppSettings): void {
  try {
    ...
    localStorage.setItem(SETTINGS_KEYS.IMAGE_MAX_SIZE, settings.imageMaxSize.toString());
    localStorage.setItem(SETTINGS_KEYS.IMAGE_QUALITY, settings.imageQuality.toString());
  } catch (err) {
